...
public class MinimumMoves {
    ...
    public void testMinimumMovesPerCellPerTarget(){
        ...
        int[] minMoves = TestBoards.LEVEL_SIMPLE.generateMinimumMovesPerCellPerTarget(0);
    ...
    public void testMinimumMovesPerCellPerTarget_NoWalls(){
        ...
        int[] minMoves = TestBoards.LEVEL_NO_WALLS.generateMinimumMovesPerCellPerTarget(0);
